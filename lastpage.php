...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
          ...
          <a class="navbar-brand" href="#">S.A.T.</a>
      </div>
...
<div class="container">
    ...
    <div class="row" id="row2">
        <div class="col-md-4">
          <h4>From Date:</h4>
          <p><a class="btn btn-default" href="#" role="button"><input id="datepickerFrom"></input></a></p>
      </div>
      <div class="col-md-4">
          <h4>To Date:</h4>
          <p><a class="btn btn-default" href="#" role="button"><input id="datepickerTo"></input></a></p>
      </div>
      <div class="col-md-4">
          <h4>View:</h4>
          <div class="btn-group">
...
<script>
      ...
      function playing() {
        ...
        for(var i=0; i <=nrows; i++)
            { 
              var line = new google.maps.Polyline({
                path: [{lat: locMatrix[i][0], lng: locMatrix[i][1]},
                {lat: 17.8674, lng: 66.543},
                {lat: locMatrix[i][2], lng: locMatrix[i][3]}],
                icons: [{
                  icon: lineSymbol,
                  offset: '100%'
              }],
